...
export const lookupTable = [
    { x1: 1, x2: 5,  x3: 10, x4: 1000, x5: 1+1+1, x6: 6 },
    { x1: 1, x2: 10, x3: 20, x4: 2000, x5: 2+2+2, x6: 8 },
    { x1: 1, x2: 15, x3: 30, x4: 3000, x5: 3+3+3, x6: 10 },
    { x1: 1, x2: 20, x3: 40, x4: 4000, x5: 4+4+4, x6: 12},
    { x1: 2, x2: 5,  x3: 10, x4: 1000, x5: 1+1+1, x6: 5 },
    { x1: 2, x2: 10, x3: 20, x4: 2000, x5: 2+2+2, x6: 7 },
    { x1: 2, x2: 15, x3: 30, x4: 3000, x5: 3+3+3, x6: 9 },
    { x1: 2, x2: 20, x3: 40, x4: 4000, x5: 4+4+4, x6: 11 },
    { x1: 3, x2: 5,  x3: 10, x4: 1000, x5: 1+1+1, x6: 4 },
    { x1: 3, x2: 10, x3: 20, x4: 2000, x5: 2+2+2, x6: 6 },
    { x1: 3, x2: 15, x3: 30, x4: 3000, x5: 3+3+3, x6: 8 },
    { x1: 3, x2: 20, x3: 40, x4: 4000, x5: 4+4+4, x6: 10 },
    { x1: 4, x2: 5,  x3: 10, x4: 1000, x5: 1+1+1, x6: 3 },
    { x1: 4, x2: 10, x3: 20, x4: 2000, x5: 2+2+2, x6: 5 },
    { x1: 4, x2: 15, x3: 30, x4: 3000, x5: 3+3+3, x6: 7 },
    { x1: 4, x2: 20, x3: 40, x4: 4000, x5: 4+4+4, x6: 9 },
